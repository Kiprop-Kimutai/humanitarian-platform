    ...
    beneficiaryRequest.save((err)=>{
        if(err){
           ...
           // res.json(new ApiResponse(true,[{"100":2200}]));
            res.json(new BeneficiaryRequestResponse(true,"100",1,"Success",{"status": true,"responseCode": "100","cardStatus": 1,"responseMessage": "Success","responseObj": {"balances": [{"walletName": "WFP","WalletBalance": 3500,"walletID": "100","currency": "Ksh"},{"walletName": "IOM","WalletBalance": 4000,"walletID": "200","currency": "Ksh"}]}}));
        }
    })
})
